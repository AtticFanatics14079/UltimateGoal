...
public class ThreadedOdometry implements Sensor {
    ...
    public void setDirection(Encoder.Direction reverse) {
    ...
    public void reverse(boolean reverse) {
        setDirection(reverse ? Encoder.Direction.REVERSE : Encoder.Direction.FORWARD);
    }
}